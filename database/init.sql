...
CREATE TABLE User_Sessions (
  ...
  login_time TIMESTAMP WITH TIME ZONE NOT NULL CHECK (login_time <= CURRENT_TIMESTAMP),
  expire_time TIMESTAMP WITH TIME ZONE NOT NULL CHECK (expire_time > CURRENT_TIMESTAMP)
);
